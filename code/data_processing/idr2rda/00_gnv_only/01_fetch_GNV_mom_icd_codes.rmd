...
# rename
GNV_mom_all_icd_codes_10_2025=mom_all_icd_codes %>%
...
# ----------------------------------------------------------------------- #
mom_all_icd_codes_tmp2 =full_join(mom_baby_link_ALL, GNV_mom_all_icd_codes_10_2025, by = "part_id_mom", relationship = "many-to-many") %>%
  mutate(
          # Compute days-to-diagnosis relative to date-of-birth
        dx2delivery_days = as.numeric(dx_date - ymd(part_dob_infant))) 

# rename
GNV_mom_icd_codes_10_2025=mom_all_icd_codes_tmp2
...
save(GNV_mom_icd_codes_10_2025, file = shared_path)

# Save locally
save(GNV_mom_icd_codes_10_2025, file = local_path)
