---
title: "fetch_data: medication-ip (February 2025)"
...
# OBJECTIVE: Export medication-ip as rda file.
```
...
# ----------------------------------------------------------------------- #
medication_ip_mom_tmp2 <- full_join(medication_ip_mom_tmp, mom_baby_link_02_2025, by = "part_id_mom") %>%
  mutate(
...
# rename
medication_ip_mom_02_2025=medication_ip_mom_tmp2
...
file_name="medication_ip_mom_02_2025.rda"
data_export_directory=paste0("V:/FACULTY/DJLEMAS/EHR_Data/processed/10year_data/") 
data_export_path=paste0(data_export_directory,file_name)
medication_ip_mom_02_2025 %>% save(medication_ip_mom_02_2025, file=data_export_path)
```
