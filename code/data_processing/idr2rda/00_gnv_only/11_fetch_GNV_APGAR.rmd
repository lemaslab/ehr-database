---
title: "fetch_data: APGAR (October 2025; Gainesville)"
...
# ----------------------------------------------------------------------- #
apgar_infant_tmp2 =full_join(apgar_infant_tmp, mom_baby_link_tmp , by = "part_id_infant") %>%
  select(part_id_infant,delivery_id,everything())

# rename
GNV_apgar_infant_10_2025=apgar_infant_tmp2
...
save(GNV_apgar_infant_10_2025, file = shared_path)

# Save locally
save(GNV_apgar_infant_10_2025, file = local_path)
