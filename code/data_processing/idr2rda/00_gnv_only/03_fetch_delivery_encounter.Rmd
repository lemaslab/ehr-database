...
# rename
GNV_delivery_encounter_02_2025=delivery_encounter_tmp2
```

mom_all_icd_codes_tmp2 =full_join(GNV_mom_all_icd_codes_04_2025, mom_baby_link_ALL, by = "part_id_mom") %>%
  mutate(
          # Compute days-to-diagnosis relative to date-of-birth
        dx2delivery_days = as.numeric(dx_date - ymd(part_dob_infant))) 

# rename
GNV_mom_icd_codes_04_2025=mom_all_icd_codes_tmp2
