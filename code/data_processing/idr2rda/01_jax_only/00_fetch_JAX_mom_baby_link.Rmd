---
title: "fetch_data: mom-baby link (October 2025; Jacksonville)"
...
# - Checked to ensure multiples are linked correctly.
...
# **************************************************************************** #
#    JACKSONVILLE:              baby_mom_link Data Import                           
# **************************************************************************** #
...
# - Prepare data for merging into mom-baby linkage to compute delivery-id.

# Dataset Summary:
# - Rows: 29,944            
# - Columns: 6         
# - Unique Baby IDs: 29,944
# - Unique Mom IDs: 22,889
...
# rename
JAX_mom_baby_link_10_2025=mom_baby_link %>%
...
shared_dir <- "V:/FACULTY/DJLEMAS/EHR_Data/processed/READ_ONLY_DATASETS/10year_data/JAX/"
...
save(JAX_mom_baby_link_10_2025, file = shared_path)

# Save locally
save(JAX_mom_baby_link_10_2025, file = local_path)
