---
title: "fetch_data: delivery encounter data (June 2025; Jacksonville)"
...
# OBJECTIVE:
# - Export mom-baby delivery data as an RDA file
...
# **************************************************************************** #
#    JACKSONVILLE:         baby_mom_at_birth_Jax.csv                         
# **************************************************************************** #

# Task:
# - Import and process baby-mom delivery encounter data.
# - Ensure consistent formatting of identifiers.
# - Prepare data for downstream analysis.

# ----------------------------------------------------------------------- #
# Step 1: Pull & Format Data
# ----------------------------------------------------------------------- #

# Dataset Summary:
# - Rows:            29,944
# - Columns:         19
# - Unique Mom IDs:  22,889
...
delivery_encounter_tmp=read_csv(data_import_path, col_types = col_types) %>%
  rename(part_id_mom_tmp=Deidentified_mom_ID,
         ...
         admit_height_inches_mom=admit_height_in,
  ...
  mutate(  # Categorize Gestational Age, Birth Weight, and Infant Size
...
# ----------------------------------------------------------------------- #
delivery_encounter_tmp2 =left_join(delivery_encounter_tmp, mom_baby_link_tmp, by = "part_id_infant") %>%
  select(part_id_infant,part_id_mom,delivery_id,everything()) %>%
  mutate(# Compute days-to-event relative to date-of-birth
           admit2delivery_days = as.numeric(delivery_admit_date - ymd(part_dob_infant))) %>%
  select(part_id_infant, part_id_mom, delivery_id, part_dob_infant, delivery_admit_date,admit2delivery_days,
         everything())

# rename
JAX_delivery_encounter_06_2025=delivery_encounter_tmp2
```
...
## EXPORT 
file_name="JAX_delivery_encounter"
...
JAX_delivery_encounter_06_2025 %>% save(JAX_delivery_encounter_06_2025, file=data_export_path)
```
