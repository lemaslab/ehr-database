...
lemaslab_code="ehr-database/code/data_processing/idr2redcap_09_2021/getData_delivery.rmd"
...
The raw data contains `r dim(delivery)[1]` rows and `r dim(delivery)[2]` columns. There are `r length(unique(newdata$baby_id))` unique baby-ids and `r length(unique(newdata$mom_id))` unique mom-ids. 

The names of column variables includes: `r names(newdata)`
