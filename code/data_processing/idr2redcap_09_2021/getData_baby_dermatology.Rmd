...
skin_01=read_csv(data_import_path, col_types = cols()) %>% 
...
# import data-02
data_file_name="baby_sebor.csv"
data_import_path=paste0(data_dir,data_file_name)
skin_02=read_csv(data_import_path, col_types = cols()) %>% 
  rename(part_id = `Deidentified_baby_ID`, 
         skin_dx_date = `Diagnosis Start Date`,
         skin_dx_code = `Diagnosis Code`,
         skin_dx_descrip = `Diagnosis Description`,
...
# import data-03
data_file_name="baby_nevus.csv"
data_import_path=paste0(data_dir,data_file_name)
skin_03=read_csv(data_import_path, col_types = cols()) %>% 
  rename(part_id = `Deidentified_baby_ID`, 
         skin_dx_date = `Diagnosis Start Date`,
         skin_dx_code = `Diagnosis Code`,
         skin_dx_descrip = `Diagnosis Description`,
...
# import data-04
data_file_name="baby_hemangonia.csv"
data_import_path=paste0(data_dir,data_file_name)
skin_04=read_csv(data_import_path, col_types = cols()) %>% 
  rename(part_id = `Deidentified_baby_ID`, 
         skin_dx_date = `Diagnosis Start Date`,
         skin_dx_code = `Diagnosis Code`,
         skin_dx_descrip = `Diagnosis Description`,
...
# import data-05
data_file_name="baby_eczema.csv"
data_import_path=paste0(data_dir,data_file_name)
skin_05=read_csv(data_import_path, col_types = cols()) %>% 
  rename(part_id = `Deidentified_baby_ID`, 
         skin_dx_date = `Diagnosis Start Date`,
         skin_dx_code = `Diagnosis Code`,
         skin_dx_descrip = `Diagnosis Description`,
...
# combine: skin_01, skin_02, skin_03, skin_04, skin_05
newdata=bind_rows(skin_01, skin_02, skin_03, skin_04, skin_05) 
...
output_dir=paste0("V:/FACULTY/DJLEMAS/EHR_Data/processed/redcap_ready/baby_dermatology/")
