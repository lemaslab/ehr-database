...
delivery_select=newdata %>%
  select(-mom_race,-mom_ethnicity,-baby_race, -baby_ethnicity)

# format dates
delivery_ready = delivery_select %>%
  mutate(part_dob=mdy_hm(part_dob),
         baby_admit_date=mdy(delivery_admit_date))
...
# drop (most of) BABY variables & MOM anthros
baby=newdata %>%
