---
title: 'IDR-to-Redcap: delivery-baby'
output:
...
The raw data contains `r dim(delivery)[1]` rows and `r dim(delivery)[2]` columns. There are `r length(unique(newdata$baby_id))` unique baby-ids. 
